...
public class ListOfPatientsView extends VerticalLayout implements View {
    ...
    private void init(List<Patient> patientList) {
        ...
        grid.setColumnOrder("name", "lastName", "patronymic", "phoneNumber");
    ...
    private void updateList() {
        ...
        if (patientList == null) {
            ...
            BeanItemContainer<Patient> bic = (BeanItemContainer<Patient>) grid.getContainerDataSource();
            bic.removeAllItems();
            bic.addAll(patientList);
